name := 'battery-status'
appid := 'dev.mariinkys.BatteryStatus'
...
install:
    ...
    install -Dm0644 resources/dev.mariinkys.BatteryStatus.desktop {{desktop-dst}}
    install -Dm0644 resources/dev.mariinkys.BatteryStatus.metainfo.xml {{appdata-dst}}
